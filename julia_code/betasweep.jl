...
const OUTPUT_DIRECTORY = "C:/Users/Daniel/Desktop/simresults_varying_beta"
...
const dt = 0.05
const duration = 80.0
const fixed_migration_rate = 0.001  # Example fixed migration rate
...
function run_single_simulation(args)
    ...
    population2 = Population(L, dx, r, M, beta_value, alpha, gamma, D, Nh, viral_density2, immune_density)
    
    migration_matrix = [0.0 fixed_migration_rate; fixed_migration_rate 0.0]
