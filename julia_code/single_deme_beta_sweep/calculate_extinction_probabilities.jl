...
const DATA_DIRECTORY = "C:/Users/Daniel/Desktop/simresults_single_deme_beta_sweep"
const OUTPUT_PATH = "C:/Users/Daniel/Documents/Github/viral-coev-net/julia_code/single_deme_beta_sweep/plotted_results_beta_sweep/"
...
function calculate_probabilities(beta_value, cutoff, drift_time_cutoff)
    ...
    Threads.@threads for idx in 1:length(files)
        ...
        elseif total_infected_end > cutoff
    ...
    println()
    prob_survival = sum(survival_outcomes) / length(files)
