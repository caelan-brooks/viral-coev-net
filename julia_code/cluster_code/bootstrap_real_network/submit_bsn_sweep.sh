...
#SBATCH -p sched_mit_hill,sched_any,mit_normal,newnodes   # Partition name
#SBATCH -t 0-11:58          # time taken is 4 hrs
#SBATCH --mem-per-cpu=3000  # Memory per CPU (adjust this based on your requirements)
#SBATCH --array=1-30        # Create a job array for 10 jobs
...
julia --project=$JULIA_PROJECT_PATH -t 12 sweep_bsn.jl