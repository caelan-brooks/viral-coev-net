...
#SBATCH --mem-per-cpu=1500  # Memory per CPU (adjust this based on your requirements)
#SBATCH --array=100-210        # Create a job array for 10 jobs
...
julia --project=$JULIA_PROJECT_PATH -t 12 peak_scaling_sweep.jl